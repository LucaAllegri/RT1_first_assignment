...
class Input_Controller : public rclcpp::Node{
    public:
        Input_Controller(): Node("input_controller"){
            ...
            id_moved_turtle_pub = this->create_publisher<std_msgs::msg::Int8>("/id_moved_turtle", 10);
    ...
    private:
        ...
        void input_timer_callback(){
            ...
            if(n_turtle == 1 || n_turtle ==2){
                ...
                moving_turtle_.data = n_turtle;
                

                if(n_turtle == 1){
                    t1_publisher_->publish(vel_input);
                    id_moved_turtle_pub->publish(moving_turtle_);
                }else if(n_turtle ==2){
        ...
        rclcpp::Publisher<std_msgs::msg::Int8>::SharedPtr id_moved_turtle_pub;
        ...
        std_msgs::msg::Int8 moving_turtle_;
        geometry_msgs::msg::Twist last_vel_input;
